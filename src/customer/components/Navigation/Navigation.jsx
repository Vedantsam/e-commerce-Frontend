      ...
      sections: [
        {
          ...
          items: [
            { name: "Tops", href: "#" },
            { name: "Mens Kurta", href: "/men/clothing/mens_kurta", id: "mens_kurta" }, // Added Mens Kurta
            { name: "Pants", href: "#" },
            { name: "Sweaters", href: "#" },
            { name: "T-Shirts", href: "#" },
            { name: "Jackets", href: "#" },
...
export default function Navigation() {
  ...
  const handleCategoryClick = (category, section, item, close) => {
    // Special handling for mens_kurta
    if (item.id === "mens_kurta") {
      navigate("/men/clothing/mens_kurta");
    } else {
      // Default navigation pattern
      navigate(`/${category.id}/${section.id}/${item.name.toLowerCase().replace(/\s+/g, '_')}`);
    }
    close();
  };

  // Handle direct navigation for items with href
  const handleDirectNavigation = (item, close) => {
                        ...
                        >
                          {section.items.map((item) => (
                            <li key={item.name} className="flow-root">
                              <button
                                className="-m-2 block p-2 text-gray-500 w-full text-left hover:text-gray-700"
                                onClick={() => {
                                  if (item.href && item.href !== "#") {
                                    handleDirectNavigation(item, () => setOpen(false));
                                  } else {
                                    handleCategoryClick(
                                      category,
                                      section,
                                    ...
                                    >
                                      {section.items.map((item) => (
                                        <li key={item.name} className="flex">
                                          <button
                                            className="hover:text-gray-800 text-left w-full transition-colors duration-150"
                                            onClick={() => {
                                              if (item.href && item.href !== "#") {
                  ...
                  <Menu as="div" className="relative">
                    ...
                    >
                      <img
                        ...
                        alt="User Avatar"
                      />
                      <span className="ml-3 text-sm font-medium">Vedant</span>
